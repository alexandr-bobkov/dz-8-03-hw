...
**Текст использованных команд**
	...
	на порт 10051, на нем Zabbix слушает информацию от Агентов, это нужно в том
	случае, если Агент отсылает информаицю в Zabbix, а не только Zabbix запрашивает 
